...
#             SystemExit, f"Error: Probabilistic fact ->{fact}<- ill formed", pasta_parser.check_consistent_prob_fact, fact)
...
#         # pars = pasta_parser.PastaParser("test.pl", 3)
#         fact = "0.5::a"
#         self.assertRaisesRegex(SystemExit, f"Error: Probabilistic fact ->{fact}<- ill formed", pasta_parser.check_consistent_prob_fact, fact)
